...
namespace ISchemm.WinFormsOAuth
{
    public class OAuthFlickr : oAuthBase
    {
		...
		public OAuthFlickr(string consumerKey, string consumerSecret) {
		...
		public const string REQUEST_TOKEN = "https://www.flickr.com/services/oauth/request_token";
		public const string AUTHORIZE = "https://www.flickr.com/services/oauth/authorize";
		public const string ACCESS_TOKEN = "https://www.flickr.com/services/oauth/access_token";
        ...
        /// <summary>
        /// Get the Flickr request token using the consumer key and secret.  Also initializes tokensecret
        /// </summary>
        ...
        /// <summary>
        /// Get the link to Flickr's authorization page for this application.
        /// </summary>
